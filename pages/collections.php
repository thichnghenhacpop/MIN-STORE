                ...
                <div>
                    <ul class=" text-gray-400 font-medium text-sm flex justify-center gap-x-6">
                        ...
                        <li class="hover:text-black duration-500 flex items-center gap-x-1 relative group">
                            <a class="text-black" href="collections.php?collection=PARISIAN%20LADY">BỘ SƯU TẬP</a>
                            <i class="fa-solid fa-chevron-down text-[10px]"></i>
                            <div
            ...
            <section class="max-w-screen-xl mx-auto text-xs grid grid-cols-12 max-h-full " style="margin-top:50px;">
                ...
                <section class="grid col-span-3">
                    <ul>
                        ...
                        <li class="font-bold">
                            <a class="block my-1" href="collections.php?collection=PARISIAN%20LADY">PARISIAN LADY</a>
                            <a class="block my-1" href="collections.php?collection=STARRY%20NIGHT">STARRY NIGHT</a>
                            <a class="block my-1" href="collections.php?collection=WINTER%20MEMORIES">WINTER
                                MEMORIES</a>
                        </li>
                        <li class="mt-4">
                            <a href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=dam"
                                class="font-bold">Đầm</a>
                            <ul>
                                <li class="mt-2"><a
                                        href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=dam&model=damsuong">Đầm
                                        Suông</a></li>
                                <li class="my-1"><a
                                        href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=dam&model=dangA">Đầm
                                        Dáng A</a></li>
                                <li class="mb-2"><a
                                        href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=dam&model=dangom">Đầm
                                        Ôm</a></li>
                            </ul>
                        </li>
                        <li class="mt-4">
                            <a href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=somi"
                                class="font-bold">Áo sơ mi</a>
                            <ul>
                                <li class="mt-2"><a
                                        href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=somi&model=daitay">Dài
                                        Tay</a></li>
                                <li class="my-1"><a
                                        href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=somi&model=ngantay">Ngắn
                                        Tay</a></li>
                                <li class="mb-2"><a
                                        href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=somi&model=taylo">Tay
                                        Lỡ</a></li>
                            </ul>
                        </li>
                        <li class="mt-4">
                            <a href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=quan"
                                class="font-bold">Quần</a>
                            <ul>
                                <li class="mt-2"><a
                                        href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=quan&model=short">Quần
                                        Short</a></li>
                                <li class="my-1"><a
                                        href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=quan&model=lung">Quần
                                        Lửng</a></li>
                                <li class="mb-2"><a
                                        href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=quan&model=dai">Quần
                                        Dài</a></li>
                            </ul>
                        </li>
                        <li class="mt-4">
                            <a href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=vay"
                                class="font-bold">Chân Váy</a>
                            <ul>
                                <li class="mt-2"><a
                                        href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=vay&model=xepli">Chân
                                        Váy Xếp Li</a></li>
                                <li class="my-1"><a
                                        href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=vay&model=butchi">Chân
                                        Váy Bút Chì</a></li>
                            </ul>
                        </li>
                        <li class="mt-4">
                            <a href="collections.php?collection=<?php echo $_GET['collection'] ?>&category=setbo"
                                class="font-bold">Set Bộ</a>
                        </li>
                    </ul>
                </section>
                ...
                <section class=" col-span-9 h-full ">
                    ...
                    <div class="flex justify-between items-center" style="height:40px;">
                        ...
                        <div class="">
                            ...
                            if (isset($_GET['collection'])) {
                                $txt_collection = $_GET['collection'];
                                switch ($txt_collection) {
                                    case 'PARISIAN LADY':
                                        $title = 'PARISIAN LADY';
                                        break;
                                    case 'STARRY NIGHT':
                                ...
                                <div
                                    ...
                                    <ul class="px-4 ">
                                        <li class="py-2 hover:cursor-pointer">
                                            ...
                                            <a href="?collection=<?php echo $_GET['collection'] ?>&sort=low">
                                                <i class="fa-solid fa-arrow-up-wide-short"></i>
                                                <span class="text-xs">Giá từ thấp đến cao</span>
                                            </a>
                                        </li>
                                        <li class="pb-2 hover:cursor-pointer">
                                            <a href="?<?php echo $_GET['collection'] ?>sort=high">
                    ...
                    <div class="grid grid-cols-3 grid-rows-2 gap-x-4 gap-y-6 mt-4">
                        ...
                        if (isset($_POST['btn-search'])) {
                            ...
                            $sql_records .= " WHERE product_name LIKE :search_term AND product_collection LIKE :collection";
                        } else {
                            $sql_records .= " WHERE product_collection LIKE :collection";
                        }
                        ...
                        $stmt_records->bindParam(':collection', $collectionParam, PDO::PARAM_STR);

                        $stmt_records->execute();

                        $total_records = $stmt_records->fetch(PDO::FETCH_ASSOC);

                        // Check if the query was successful before using the data
                        if ($total_records) {
                            ...
                            if (isset($_POST['btn-search'])) {
                                $sql .= " WHERE product_name LIKE :search_term AND product_collection LIKE :collection";
                                $txt_search = str_replace('d', 'đ', $txt_search);
                            } else {
                                $sql .= " WHERE product_collection LIKE :collection";
                            }
                            ...
                            $stmt->bindParam(':collection', $collectionParam, PDO::PARAM_STR);
                        ...
                        <ul class="flex justify-center">
                            ...
                            for ($i = max(1, $current_page - 2); $i <= min($current_page + 2, $total_pages); $i++) {
                                ...
                                if ($i == $current_page) {
                                    ...
                                    echo '<li><a href="?collection=' . $_GET['collection'] . '&page=' . $i .  $param_sort . $param_category . $param_model .'" class="h-10 w-10 bg-gray-200 text-black flex mr-3 justify-center items-center text-base group-hover:cursor-pointer hover:bg-black hover:text-white duration-700">' . $i . '</a></li>';
                                }
                            }

                            if ($showPrevNext && $current_page < $total_pages) {

                                echo '<li><a href="?collection=' . $_GET['collection'] . '&page=' . ($current_page + 1) .  $param_sort . $param_category . $param_model .'" class="h-10 w-16 bg-gray-200 text-black flex mr-3 justify-center items-center text-base group-hover:cursor-pointer hover:bg-black hover:text-white duration-700">Next</a></li>';
                            }
                            ?>
                        </ul>
                    </div>
