            ...
            <nav
                ...
                <div>
                    <ul class=" text-gray-400 font-medium text-sm flex justify-center gap-x-6">
                        ...
                        <li class="hover:text-black duration-500 flex items-center gap-x-1 relative group">
                            <a class="text-black" href="sale.php?price=500">ĐỒNG GIÁ</a>
                            <i class="fa-solid fa-chevron-down text-[10px]"></i>
                            <div
                                class="absolute top-full -left-10 bg-white w-44 translate-y-2 shadow-xl hidden group-hover:block animate__animated animate__fadeInUp duration-150 ">
            ...
            <section class="max-w-screen-xl mx-auto text-xs grid grid-cols-12 max-h-full " style="margin-top:50px;">
                ...
                <section class="grid col-span-3">
                    <ul>
                        ...
                        <li class="font-bold">
                            <a class="block my-1" href="sale.php?price=500">Dưới 500K</a>
                            <a class="block my-1" href="sale.php?price=500-1000">Từ 500K Đến 1 Triệu</a>
                            <a class="block my-1" href="sale.php?price=>1000">Trên 1 Triệu</a>
                        </li>
                        <li class="mt-4">
                            <a href="sale.php?price=<?php echo $_GET['price'] ?>&category=dam"
                                class="font-bold">Đầm</a>
                            <ul>
                                <li class="mt-2"><a
                                        href="sale.php?price=<?php echo $_GET['price'] ?>&category=dam&model=damsuong">Đầm
                                        Suông</a></li>
                                <li class="my-1"><a
                                        href="sale.php?price=<?php echo $_GET['price'] ?>&category=dam&model=dangA">Đầm
                                        Dáng A</a></li>
                                <li class="mb-2"><a
                                        href="sale.php?price=<?php echo $_GET['price'] ?>&category=dam&model=dangom">Đầm
                                        Ôm</a></li>
                            </ul>
                        </li>
                        <li class="mt-4">
                            <a href="sale.php?price=<?php echo $_GET['price'] ?>&category=somi" class="font-bold">Áo sơ
                                mi</a>
                            <ul>
                                <li class="mt-2"><a
                                        href="sale.php?price=<?php echo $_GET['price'] ?>&category=somi&model=daitay">Dài
                                        Tay</a></li>
                                <li class="my-1"><a
                                        href="sale.php?price=<?php echo $_GET['price'] ?>&category=somi&model=ngantay">Ngắn
                                        Tay</a></li>
                                <li class="mb-2"><a
                                        href="sale.php?price=<?php echo $_GET['price'] ?>&category=somi&model=taylo">Tay
                                        Lỡ</a></li>
                            </ul>
                        </li>
                        <li class="mt-4">
                            <a href="sale.php?price=<?php echo $_GET['price'] ?>&category=quan"
                                class="font-bold">Quần</a>
                            <ul>
                                <li class="mt-2"><a
                                        href="sale.php?price=<?php echo $_GET['price'] ?>&category=quan&model=short">Quần
                                        Short</a></li>
                                <li class="my-1"><a
                                        href="sale.php?price=<?php echo $_GET['price'] ?>&category=quan&model=lung">Quần
                                        Lửng</a></li>
                                <li class="mb-2"><a
                                        href="sale.php?price=<?php echo $_GET['price'] ?>&category=quan&model=dai">Quần
                                        Dài</a></li>
                            </ul>
                        </li>
                        <li class="mt-4">
                            <a href="sale.php?price=<?php echo $_GET['price'] ?>&category=vay" class="font-bold">Chân
                                Váy</a>
                            <ul>
                                <li class="mt-2"><a
                                        href="sale.php?price=<?php echo $_GET['price'] ?>&category=vay&model=xepli">Chân
                                        Váy Xếp Li</a></li>
                                <li class="my-1"><a
                                        href="sale.php?price=<?php echo $_GET['price'] ?>&category=vay&model=butchi">Chân
                                        Váy Bút Chì</a></li>
                            </ul>
                        </li>
                        <li class="mt-4">
                            <a href="sale.php?price=<?php echo $_GET['price'] ?>&category=setbo" class="font-bold">Set
                                Bộ</a>
                        </li>
                    </ul>
                </section>
                ...
                <section class=" col-span-9 h-full ">
                    ...
                    <div class="flex justify-between items-center" style="height:40px;">
                        ...
                        <div class="">
                            ...
                            $title = '';
                            if (isset($_GET['price'])) {
                                $txt_price = $_GET['price'];
                                switch ($txt_price) {
                                    case '500':
                                        $title = 'ĐỒNG GIÁ 500K';
                                        break;
                                    case '500-1000':
                                        $title = 'TỪ 500K ĐẾN 1 TRIỆU';
                                        break;
                                    case '>1000':
                                        $title = 'TRÊN 1 TRIỆU';
                                        break;
                    ...
                    <div class="grid grid-cols-3 grid-rows-2 gap-x-4 gap-y-6 mt-4">
                        ...
                        switch ($get_price) {
                            case '500':
                                $sql_records .= "AND product_price < 500000";
                                break;
                            case '500-1000':
                                $sql_records .= "AND product_price BETWEEN 500000 AND 1000000";
                                break;
                            case '>1000':
                                $sql_records .= "AND product_price > 1000000";
                                break;
                        }
                        ...
                        if ($total_records) {
                            ...
                            switch ($get_price) {
                                case '500':
                                    $sql .= "AND product_price < 500000";
                                    break;
                                case '500-1000':
                                    $sql .= "AND product_price BETWEEN 500000 AND 1000000";
                                    break;
                                case '>1000':
                        ...
                        <ul class="flex justify-center">
                            ...
                            for ($i = max(1, $current_page - 2); $i <= min($current_page + 2, $total_pages); $i++) {
                                ...
                                if ($i == $current_page) {
                                    ...
                                    echo '<li><a href="?price=' . $_GET['price'] . '&page=' . $i . $param_sort . $param_category . $param_model .'" class="h-10 w-10 bg-gray-200 text-black flex mr-3 justify-center items-center text-base group-hover:cursor-pointer hover:bg-black hover:text-white duration-700">' . $i . '</a></li>';
                                }
                            }

                            if ($showPrevNext && $current_page < $total_pages) {

                                echo '<li><a href="?price=' . $_GET['price'] . '&page=' . ($current_page + 1) . $param_sort . $param_category . $param_model . '" class="h-10 w-16 bg-gray-200 text-black flex mr-3 justify-center items-center text-base group-hover:cursor-pointer hover:bg-black hover:text-white duration-700">Next</a></li>';
                            }
                            ?>
                        </ul>
                    </div>
