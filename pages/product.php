            ...
            <section class="max-w-screen-xl mx-auto text-xs grid grid-cols-12 max-h-full " style="margin-top:50px;">
                ...
                <section class="grid col-span-3">
                    <ul>
                        ...
                        <li class="font-bold">
                            <a href="product.php">Tất cả sản phẩm</a>
                        </li>
                        <li class="mt-4">
                            <a href="product.php?category=dam" class="font-bold">Đầm</a>
                            <ul>
                                <li class="mt-2"><a href="product.php?category=dam&model=damsuong">Đầm Suông</a></li>
                                <li class="my-1"><a href="product.php?category=dam&model=dangA">Đầm Dáng A</a></li>
                                <li class="mb-2"><a href="product.php?category=dam&model=dangom">Đầm Ôm</a></li>
                            </ul>
                        </li>
                        <li class="mt-4">
                            <a href="product.php?category=somi" class="font-bold">Áo sơ mi</a>
                            <ul>
                                <li class="mt-2"><a href="product.php?category=somi&model=daitay">Dài Tay</a></li>
                                <li class="my-1"><a href="product.php?category=somi&model=ngantay">Ngắn Tay</a></li>
                                <li class="mb-2"><a href="product.php?category=somi&model=taylo">Tay Lỡ</a></li>
                            </ul>
                        </li>
                        <li class="mt-4">
                            <a href="product.php?category=quan" class="font-bold">Quần</a>
                            <ul>
                                <li class="mt-2"><a href="product.php?category=quan&model=short">Quần Short</a></li>
                                <li class="my-1"><a href="product.php?category=quan&model=lung">Quần Lửng</a></li>
                                <li class="mb-2"><a href="product.php?category=quan&model=dai">Quần Dài</a></li>
                            </ul>
                        </li>
                        <li class="mt-4">
                            <a href="product.php?category=vay" class="font-bold">Chân Váy</a>
                            <ul>
                                <li class="mt-2"><a href="product.php?category=vay&model=xepli">Chân Váy Xếp Li</a>
                                </li>
                                <li class="my-1"><a href="product.php?category=vay&model=butchi">Chân Váy Bút Chì</a>
                                </li>
                            </ul>
                        </li>
                        <li class="mt-4">
                            <a href="product.php?category=setbo" class="font-bold">Set Bộ</a>
                        </li>
                    </ul>
                </section>
